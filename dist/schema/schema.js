import { GraphQLObjectType, GraphQLID, GraphQLString, GraphQLNonNull, GraphQLList, GraphQLSchema, } from "graphql";
        ...
        loginUser: {
            ...
            async resolve(parent, { email, password }) {
                ...
                try {
                    ...
                    const decryptedPassword = bcrypt.compareSync(password, 
                    //@ts-ignore
        ...
        deleteBlog: {
            ...
            async resolve(root, { id }) {
                ...
                try {
                    ...
                    if (!existingUser)
                        return new Error("NO USER FOUND! Exiting");
